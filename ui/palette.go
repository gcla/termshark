...
func SetupColors() {
	...
	RegularPalette = gowid.Palette{
		...
		"dialog-buttons":            gowid.MakePaletteEntry(lfg("dialog-buttons", gowid.ColorYellow), lbg("dialog-buttons", gowid.ColorBlack)),
		"cmdline":                   gowid.MakePaletteEntry(lfg("cmdline", gowid.ColorBlack), lbg("cmdline", gowid.ColorYellow)),
		"cmdline-buttons":           gowid.MakePaletteEntry(lfg("cmdline-buttons", gowid.ColorYellow), lbg("cmdline-buttons", gowid.ColorBlack)),
	...
	DarkModePalette = gowid.Palette{
		...
		"dialog-buttons":            gowid.MakePaletteEntry(dfg("dialog-button", gowid.ColorYellow), dbg("dialog-button", gowid.ColorBlack)),
		"cmdline":                   gowid.MakePaletteEntry(dfg("cmdline", gowid.ColorBlack), dbg("cmdline", gowid.ColorYellow)),
		"cmdline-buttons":           gowid.MakePaletteEntry(dfg("cmdline-button", gowid.ColorYellow), dbg("cmdline-button", gowid.ColorBlack)),
		...
		"progress-default":          gowid.MakeStyledPaletteEntry(dfg("progress", gowid.ColorWhite), dbg("progress", gowid.ColorBlack), gowid.StyleBold),
